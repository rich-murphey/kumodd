...
In the metadata, values generated by kumodd should be separated
...
Either Username should be a command line option, and the account token
filename should vary by user name accordingly.
